...
# 2.6 Utilizing tools from the Registry
...
Instead of starting with a plain base image such as ubuntu, the Dockerfile in the example takes as starting point image `ruby:3.1` that is a pre-build image found in [Docker hub](https://hub.docker.com/_/ruby). Pre-built programming language Docker images, such as those for Ruby and Python, are Docker images that come with a specific programming language and its runtime environment already installed and configured. These images are provided by the Docker community or the language's maintainers and are available on Docker Hub.

One of the benefits of using a pre-build image is simplicity of setting up the development environment. You don’t need to manually install and configure the language runtime and dependencies.

---

## Exercises 1.11 - Spring
...
---
> **The course project and mandatory exercises**
...
> **The course project related exercises are mandatory and you should do those to get a passing grade.**
...
_Give the Dockerfile and the commands you used for building and running the image as the answer._
